...
- Create Angular project with ng: `ng new s4labour.techtest.web.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`s4labour.techtest.web.client.esproj`).
